...
export const VideoCall = ({
  ...
  return <div className="flex flex-col h-screen">
      ...
      <div className="bg-gray-800 text-white p-4 flex justify-between items-center">
        <h1 className="text-xl font-bold">AI-Assisted Meeting</h1>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-80 bg-gray-50 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <Participants participants={participants} onNavigateToConversation={onNavigateToConversation} />
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-800 text-white p-4 flex justify-center items-center space-x-6">
        ...
        <button className="px-4 py-2 rounded-md bg-gray-600 hover:bg-gray-500 text-sm" onClick={() => setIsFacilitatorPresent(!isFacilitatorPresent)}>
