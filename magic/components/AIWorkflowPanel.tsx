          ...
          <div className="lg:w-2/3 bg-slate-50 rounded-xl border border-slate-200 p-6 overflow-auto">
            ...
            transformOrigin: 'top left'
              ...
              minHeight: '500px'
                ...
                <motion.path d="M180,100 C220,100 220,200 260,200" stroke={workflowProgress.preprocessing !== 'idle' ? '#3B82F6' : '#CBD5E1'} strokeWidth="2" fill="none" strokeDasharray={workflowProgress.preprocessing === 'running' ? '5,5' : 'none'} initial={{
                pathLength: 0
              }} animate={{
                ...
                <motion.path d="M380,200 C420,200 420,100 460,100" stroke={workflowProgress.featureExtraction !== 'idle' ? '#3B82F6' : '#CBD5E1'} strokeWidth="2" fill="none" strokeDasharray={workflowProgress.featureExtraction === 'running' ? '5,5' : 'none'} initial={{
                pathLength: 0
              }} animate={{
                ...
                <motion.path d="M580,100 C620,100 620,200 660,200" stroke={workflowProgress.modelTraining !== 'idle' ? '#3B82F6' : '#CBD5E1'} strokeWidth="2" fill="none" strokeDasharray={workflowProgress.modelTraining === 'running' ? '5,5' : 'none'} initial={{
                pathLength: 0
              }} animate={{
                ...
                <motion.path d="M380,300 C420,300 420,400 460,400" stroke={workflowProgress.evaluation !== 'idle' ? '#3B82F6' : '#CBD5E1'} strokeWidth="2" fill="none" strokeDasharray={workflowProgress.evaluation === 'running' ? '5,5' : 'none'} initial={{
                pathLength: 0
              }} animate={{
                ...
                <motion.path d="M580,400 C620,400 620,300 660,300" stroke={workflowProgress.deployment !== 'idle' ? '#3B82F6' : '#CBD5E1'} strokeWidth="2" fill="none" strokeDasharray={workflowProgress.deployment === 'running' ? '5,5' : 'none'} initial={{
                pathLength: 0
              }} animate={{
