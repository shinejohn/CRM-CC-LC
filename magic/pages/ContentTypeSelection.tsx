...
export function ContentTypeSelection({
  ...
  const getActionButton = (type: ContentType) => {
    if (type.category === 'additional') {
      return <button className="w-full px-4 py-2 bg-[#1E3A5F] hover:bg-[#152d4a] text-white rounded-lg font-medium text-sm transition-colors">
    ...
    if (type.category === 'expert') {
      return <button onClick={() => onNavigate?.('content-create', type.id)} className="w-full px-4 py-2 bg-[#1E3A5F] hover:bg-[#152d4a] text-white rounded-lg font-medium text-sm transition-colors">
          Start Writing
        </button>;
    }
    return <button onClick={() => onNavigate?.('content-create', type.id)} className="w-full px-4 py-2 bg-[#1E3A5F] hover:bg-[#152d4a] text-white rounded-lg font-medium text-sm transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            opacity: 1,
            y: 0
          }} className="bg-white rounded-xl border-2 border-slate-200 p-6 hover:border-[#1E3A5F] transition-all">
