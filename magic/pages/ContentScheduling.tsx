        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div>
                ...
                <div className="relative">
                  <input type="date" value={startDate} onChange={e => setStartDate(e.target.value)} className="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-[#1E3A5F] focus:outline-none" />
              ...
              <div>
                ...
                <div className="relative">
                  <input type="date" value={endDate} onChange={e => setEndDate(e.target.value)} className="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-[#1E3A5F] focus:outline-none" />
                  <Calendar className="absolute right-3 top-3 w-5 h-5 text-slate-400 pointer-events-none" />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <button onClick={() => setTimingMode('continuous')} className={`w-full p-4 rounded-lg border-2 transition-all text-left ${timingMode === 'continuous' ? 'border-[#1E3A5F] bg-blue-50' : 'border-slate-200 hover:border-slate-300'}`}>
                <div className="flex items-center gap-3">
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${timingMode === 'continuous' ? 'border-[#1E3A5F] bg-[#1E3A5F]' : 'border-slate-300'}`}>
              ...
              <button onClick={() => setTimingMode('specific')} className={`w-full p-4 rounded-lg border-2 transition-all text-left ${timingMode === 'specific' ? 'border-[#1E3A5F] bg-blue-50' : 'border-slate-200 hover:border-slate-300'}`}>
                <div className="flex items-center gap-3">
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${timingMode === 'specific' ? 'border-[#1E3A5F] bg-[#1E3A5F]' : 'border-slate-300'}`}>
              ...
              <button onClick={() => setTimingMode('days')} className={`w-full p-4 rounded-lg border-2 transition-all text-left ${timingMode === 'days' ? 'border-[#1E3A5F] bg-blue-50' : 'border-slate-200 hover:border-slate-300'}`}>
                <div className="flex items-center gap-3">
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${timingMode === 'days' ? 'border-[#1E3A5F] bg-[#1E3A5F]' : 'border-slate-300'}`}>
                  ...
                  <div className="flex-1">
                    ...
                    {timingMode === 'days' && <div className="flex gap-2">
                      ...
                      e.stopPropagation();
                      toggleDay(day);
                    }} className={`px-3 py-1 rounded text-sm font-medium transition-colors ${selectedDays.includes(day) ? 'bg-[#1E3A5F] text-white' : 'bg-white border border-slate-300 text-slate-700'}`}>
                            {day}
                          </button>)}
                      </div>}
                  </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6">
            ...
            <div className="space-y-3">
              {addOnOptions.map(option => <label key={option.id} className={`flex items-start justify-between p-4 rounded-lg border-2 transition-all cursor-pointer ${addOns[option.id as keyof typeof addOns] ? 'border-[#1E3A5F] bg-blue-50' : 'border-slate-200 hover:border-slate-300'}`}>
