...
export function CommandCenterHeader({
  ...
  const displayBusiness = businessName ?? user?.business_name ?? 'My Business';
    ...
    <header className="h-[76px] bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-white/20 dark:border-slate-800 sticky top-0 z-30 flex items-center justify-between px-8 shadow-sm">
      ...
      <div className="flex items-center gap-5">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          onClick={onOrderServices || (() => navigate('/command-center/deliver'))}
        ...
        <Button
          ...
          className="relative hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full w-10 h-10"
        >
        ...
        {onToggleRightSidebar && (
          <Button
            ...
            className="hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full w-10 h-10"
        ...
        <div className="relative">
          ...
          >
            ...
            <ChevronDown
              className={`w-4 h-4 text-slate-500 transition-transform ${profileMenuOpen ? 'rotate-180' : ''}`}
            />
          </button>
              ...
              >
                ...
                <div className="p-2">
                  <button
                    type="button"
                    role="menuitem"
                    onClick={() => { navigate('/command-center/settings/profile'); setProfileMenuOpen(false); }}
                    className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-700/50 text-left transition-colors"
                  >
                  ...
                  <button
                    type="button"
                    role="menuitem"
                    onClick={() => { navigate('/command-center/settings'); setProfileMenuOpen(false); }}
                    className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-700/50 text-left transition-colors"
                  >
                ...
                <div className="p-2 border-t border-slate-100 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-800/50">
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-rose-50 dark:hover:bg-rose-500/10 text-left transition-colors"
                  >
