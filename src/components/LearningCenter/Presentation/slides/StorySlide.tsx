  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto w-full">
        <BookOpen size={64} className="mx-auto mb-6 text-blue-600 animate-fade-in" />
        ...
        {content.story && (
          <div className="bg-white rounded-lg p-8 shadow-lg animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <p className="text-gray-800 text-lg leading-relaxed whitespace-pre-line">{content.story}</p>
          </div>
        )}
      </div>
    </div>
