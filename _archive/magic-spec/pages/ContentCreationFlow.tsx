        ...
        <AnimatePresence mode="wait">
          ...
          x: -20
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <div className="space-y-4">
                  {/* Create New */}
                  <button onClick={() => handleMethodSelect('new')} className="w-full border-2 border-slate-200 rounded-xl p-6 hover:border-[color:var(--nexus-1e3a5f)] hover:bg-slate-50 transition-all text-left">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-[color:var(--nexus-1e3a5f)] text-white rounded-lg font-medium text-sm">
                          Start Fresh
                          <ChevronRight className="w-4 h-4" />
                        </div>
                      </div>
                  ...
                  {/* Use from Library */}
                  <button onClick={() => handleMethodSelect('library')} className="w-full border-2 border-slate-200 rounded-xl p-6 hover:border-[color:var(--nexus-1e3a5f)] hover:bg-slate-50 transition-all text-left">
                    <div className="flex items-start gap-4">
  ...
  return <div className="bg-white rounded-xl border border-slate-200 p-6">
      ...
      <div className="mb-6">
        ...
        <div className="space-y-2">
          ...
          ...formData,
          format: format.id
        })} className={`w-full p-4 rounded-lg border-2 transition-all text-left ${formData.format === format.id ? 'border-[color:var(--nexus-1e3a5f)] bg-blue-50' : 'border-slate-200 hover:border-slate-300'}`}>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${formData.format === format.id ? 'border-[color:var(--nexus-1e3a5f)] bg-[color:var(--nexus-1e3a5f)]' : 'border-slate-300'}`}>
      ...
      <div className="mb-6">
        ...
        <div className="border-2 border-dashed border-slate-300 rounded-xl p-12 text-center hover:border-[color:var(--nexus-1e3a5f)] transition-colors cursor-pointer">
      ...
      <div className="space-y-4 mb-6">
        ...
        })} placeholder="Winter Clearance - Up to 50% Off!" className="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-[color:var(--nexus-1e3a5f)] focus:outline-none" />
        </div>
        ...
        <div>
          ...
          ...formData,
          url: e.target.value
        })} placeholder="https://myrestaurant.com/specials" className="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-[color:var(--nexus-1e3a5f)] focus:outline-none" />
        </div>
        ...
        })} placeholder="Winter sale promotion banner for Tony's Restaurant" className="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-[color:var(--nexus-1e3a5f)] focus:outline-none" />
        </div>
      </div>
      ...
      <div className="flex items-center justify-between pt-6 border-t border-slate-200">
        ...
        <button className="px-6 py-3 bg-[color:var(--nexus-1e3a5f)] hover:bg-[color:var(--nexus-152d4a)] text-white rounded-lg font-medium transition-colors flex items-center gap-2">
          Continue
          <ChevronRight className="w-4 h-4" />
        </button>
      </div>
...
function AnnouncementCreationForm({
  ...
  return <div className="bg-white rounded-xl border border-slate-200 p-6">
      ...
      <div className="mb-6">
        ...
        })} className={`p-4 rounded-lg border-2 transition-all text-center ${formData.announcementType === type.id ? 'border-[color:var(--nexus-1e3a5f)] bg-blue-50' : 'border-slate-200 hover:border-slate-300'}`}>
      ...
      <div className="mb-6">
        ...
        ...formData,
        headline: e.target.value
      })} placeholder="Tony's Italian Celebrates 25 Years in Springfield!" maxLength={100} className="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-[color:var(--nexus-1e3a5f)] focus:outline-none" />
      ...
      <div className="mb-6">
        ...
        ...formData,
        body: e.target.value
      })} placeholder="This February marks 25 incredible years of serving the Springfield community..." rows={8} maxLength={750} className="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-[color:var(--nexus-1e3a5f)] focus:outline-none resize-none" />
        <p className="text-xs text-slate-500 mt-1">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <button className="px-4 py-2 bg-[color:var(--nexus-1e3a5f)] hover:bg-[color:var(--nexus-152d4a)] text-white rounded-lg font-medium text-sm transition-colors mb-2">
              Upload Image
            </button>
      ...
      <div className="mb-6">
        ...
        ...formData,
        url: e.target.value
      })} placeholder="https://tonysitalian.com/25years" className="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-[color:var(--nexus-1e3a5f)] focus:outline-none" />
      </div>
...
function ExpertArticleCreationForm({
  ...
  return <div className="bg-white rounded-xl border border-slate-200 p-6">
      ...
      })} placeholder="The Secret to Perfect Homemade Pasta: Tips from a Chef" className="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-[color:var(--nexus-1e3a5f)] focus:outline-none" />
      </div>
      ...
      })} placeholder="25 years of pasta-making wisdom in one simple guide" className="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-[color:var(--nexus-1e3a5f)] focus:outline-none" />
      </div>
      ...
      <div className="mb-6">
        ...
        <textarea rows={3} defaultValue="Chef Tony Russo has been crafting authentic Italian cuisine in Springfield for 25 years. As the Community Expert for Italian dining, he shares his culinary wisdom..." className="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-[color:var(--nexus-1e3a5f)] focus:outline-none resize-none" />
      </div>
