        ...
        <div className="h-64 relative flex items-end">
          ...
          <div className="ml-10 flex-1 h-full relative border-l border-b border-slate-200">
            ...
            <svg className="absolute inset-0 w-full h-full overflow-visible">
              <path d="M0,192 L80,160 L160,128 L240,96 L320,80 L400,64 L480,48" fill="none" stroke="var(--nexus-3b82f6)" strokeWidth="2" />
              <path d="M0,200 L80,168 L160,140 L240,112 L320,96 L400,88 L480,72" fill="none" stroke="var(--nexus-10b981)" strokeWidth="2" />
            </svg>
