      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-4 bg-gray-50 dark:bg-slate-900">
          ...
          delay: 0.18
            ...
            scale: 0.98
          }} onClick={() => onNavigate?.('subscription-enrollment')} className="w-full p-6 bg-gradient-to-r from-[color:var(--nexus-1e3a5f)] to-blue-700 hover:from-[color:var(--nexus-1e3a5f)]/90 hover:to-blue-700/90 rounded-xl shadow-xl hover:shadow-2xl transition-all border-2 border-[color:var(--nexus-1e3a5f)]">
              <div className="flex items-center justify-between">
