...
[ -n "$PUSHER_APP_KEY" ] && set_var "$FOA_SERVICE" "VITE_PUSHER_APP_KEY" "$PUSHER_APP_KEY"
[ -n "$PUSHER_APP_KEY" ] && set_var "$FOA_SERVICE" "VITE_PUSHER_APP_CLUSTER" "$PUSHER_APP_CLUSTER"
