...
final class ManifestDestinyTimelineSeeder extends Seeder
{
    ...
    private function seedEducationTimeline(): void
    {
        ...
        $actions = [
            ['day_number' => 2, 'channel' => 'email', 'action_type' => 'send_email', 'template_type' => 'edu_the_new_day', 'campaign_id' => 'EDU-001', 'conditions' => null, 'parameters' => ['subject' => 'The truth about SEO nobody tells local businesses', 'landing_page' => 'seo-reality-check']],
            ...
            ['day_number' => 12, 'channel' => 'email', 'action_type' => 'send_email', 'template_type' => 'edu_publishing_network', 'campaign_id' => 'EDU-003', 'conditions' => null, 'parameters' => ['subject' => 'The marketing assistant that works while you sleep', 'landing_page' => 'ai-marketing-assistant']],
            ['day_number' => 16, 'channel' => 'email', 'action_type' => 'send_email', 'template_type' => 'edu_community_marketing', 'campaign_id' => 'EDU-004', 'conditions' => null, 'parameters' => ['subject' => 'Let AI handle the busywork behind your business', 'landing_page' => 'ai-operations-guide']],
            ['day_number' => 20, 'channel' => 'email', 'action_type' => 'send_email', 'template_type' => 'edu_reputation_ai', 'campaign_id' => 'EDU-005', 'conditions' => null, 'parameters' => ['subject' => 'When people ask AI for a recommendation, is it you?', 'landing_page' => 'ai-search-visibility']],
            ['day_number' => 24, 'channel' => 'email', 'action_type' => 'send_email', 'template_type' => 'edu_ai_employee', 'campaign_id' => 'EDU-006', 'conditions' => null, 'parameters' => ['subject' => 'Why \'community marketing\' beats \'digital marketing\'', 'landing_page' => 'community-marketing']],
            ['day_number' => 28, 'channel' => 'email', 'action_type' => 'send_email', 'template_type' => 'edu_ai_content', 'campaign_id' => 'EDU-007', 'conditions' => null, 'parameters' => ['subject' => 'Your reputation is now your algorithm', 'landing_page' => 'reputation-ai-age']],
            ...
            ['day_number' => 32, 'channel' => 'email', 'action_type' => 'send_email', 'template_type' => 'edu_voice_ai', 'campaign_id' => 'EDU-008', 'conditions' => null, 'parameters' => ['subject' => 'Your customers expect instant answers. AI delivers.', 'landing_page' => 'ai-customer-service']],
            ['day_number' => 36, 'channel' => 'email', 'action_type' => 'send_email', 'template_type' => 'edu_local_seo', 'campaign_id' => 'EDU-009', 'conditions' => null, 'parameters' => ['subject' => 'Your phone can answer itself now', 'landing_page' => 'voice-ai-guide']],
            ['day_number' => 40, 'channel' => 'email', 'action_type' => 'send_email', 'template_type' => 'edu_ai_content_guide', 'campaign_id' => 'EDU-010', 'conditions' => null, 'parameters' => ['subject' => 'Local SEO isn\'t dead—it evolved', 'landing_page' => 'local-seo-guide']],
            ['day_number' => 44, 'channel' => 'email', 'action_type' => 'send_email', 'template_type' => 'edu_future_proof', 'campaign_id' => 'EDU-011', 'conditions' => null, 'parameters' => ['subject' => 'AI writes. You approve. Content happens.', 'landing_page' => 'ai-content-guide']],
            ['day_number' => 48, 'channel' => 'email', 'action_type' => 'send_email', 'template_type' => 'edu_data_privacy', 'campaign_id' => 'EDU-012', 'conditions' => null, 'parameters' => ['subject' => 'The businesses that survive the next 5 years share this', 'landing_page' => 'future-proof-guide']],
            ['day_number' => 52, 'channel' => 'email', 'action_type' => 'send_email', 'template_type' => 'edu_competitive_intel', 'campaign_id' => 'EDU-013', 'conditions' => null, 'parameters' => ['subject' => 'Your customers care about their data privacy', 'landing_page' => 'data-privacy-guide']],
            ['day_number' => 55, 'channel' => 'email', 'action_type' => 'send_email', 'template_type' => 'edu_ai_customer_service', 'campaign_id' => 'EDU-014', 'conditions' => null, 'parameters' => ['subject' => 'What your competitors know about you', 'landing_page' => 'competitive-intelligence']],
